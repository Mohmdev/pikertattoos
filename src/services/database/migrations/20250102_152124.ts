...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_cta_cta_fields_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_cta_cta_fields_settings_bg" AS ENUM('solid', 'trnsprnt', 'grdntup', 'gtdntdwn');
  CREATE TYPE "public"."enum_pages_blocks_cta_cta_fields_style" AS ENUM('buttons', 'banner');
  CREATE TYPE "public"."enum_pages_blocks_cta_cta_fields_banner_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_cta_cta_fields_banner_link_appearance" AS ENUM('default', 'outline', 'secondary', 'destructive', 'ghost', 'link');
  CREATE TYPE "public"."enum_pages_blocks_media_block_media_block_fields_settings_bg" AS ENUM('solid', 'trnsprnt', 'grdntup', 'gtdntdwn');
  CREATE TYPE "public"."enum_pages_blocks_media_block_media_block_fields_position" AS ENUM('default', 'wide');
  CREATE TYPE "public"."enum_pages_blocks_banner_banner_fields_settings_bg" AS ENUM('solid', 'trnsprnt', 'grdntup', 'gtdntdwn');
  CREATE TYPE "public"."enum_pages_blocks_banner_banner_fields_banner_type" AS ENUM('default', 'info', 'success', 'warning', 'alert', 'error');
  CREATE TYPE "public"."enum_pages_blocks_spacer_space_fields_settings_bg" AS ENUM('solid', 'trnsprnt', 'grdntup', 'gtdntdwn');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_cta_cta_fields_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_cta_cta_fields_settings_bg" AS ENUM('solid', 'trnsprnt', 'grdntup', 'gtdntdwn');
  CREATE TYPE "public"."enum__pages_v_blocks_cta_cta_fields_style" AS ENUM('buttons', 'banner');
  CREATE TYPE "public"."enum__pages_v_blocks_cta_cta_fields_banner_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_cta_cta_fields_banner_link_appearance" AS ENUM('default', 'outline', 'secondary', 'destructive', 'ghost', 'link');
  CREATE TYPE "public"."enum__pages_v_blocks_media_block_media_block_fields_settings_bg" AS ENUM('solid', 'trnsprnt', 'grdntup', 'gtdntdwn');
  CREATE TYPE "public"."enum__pages_v_blocks_media_block_media_block_fields_position" AS ENUM('default', 'wide');
  CREATE TYPE "public"."enum__pages_v_blocks_banner_banner_fields_settings_bg" AS ENUM('solid', 'trnsprnt', 'grdntup', 'gtdntdwn');
  CREATE TYPE "public"."enum__pages_v_blocks_banner_banner_fields_banner_type" AS ENUM('default', 'info', 'success', 'warning', 'alert', 'error');
  CREATE TYPE "public"."enum__pages_v_blocks_spacer_space_fields_settings_bg" AS ENUM('solid', 'trnsprnt', 'grdntup', 'gtdntdwn');
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_cta_cta_fields_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_pages_blocks_cta_cta_fields_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_cta" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"cta_fields_settings_bg" "enum_pages_blocks_cta_cta_fields_settings_bg",
  	"cta_fields_style" "enum_pages_blocks_cta_cta_fields_style" DEFAULT 'buttons',
  	"cta_fields_rich_text" jsonb,
  	"cta_fields_command_line" varchar,
  	"cta_fields_banner_link_type" "enum_pages_blocks_cta_cta_fields_banner_link_type" DEFAULT 'reference',
  	"cta_fields_banner_link_new_tab" boolean,
  	"cta_fields_banner_link_url" varchar,
  	"cta_fields_banner_link_label" varchar,
  	"cta_fields_banner_link_appearance" "enum_pages_blocks_cta_cta_fields_banner_link_appearance" DEFAULT 'default',
  	"cta_fields_banner_image_id" integer,
  	"cta_fields_gradient_background" boolean,
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_media_block" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"media_block_fields_settings_bg" "enum_pages_blocks_media_block_media_block_fields_settings_bg",
  	"media_block_fields_position" "enum_pages_blocks_media_block_media_block_fields_position" DEFAULT 'default',
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_banner" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"banner_fields_settings_bg" "enum_pages_blocks_banner_banner_fields_settings_bg",
  	"banner_fields_banner_type" "enum_pages_blocks_banner_banner_fields_banner_type" DEFAULT 'default',
  	"banner_fields_add_checkmark" boolean,
  	"banner_fields_rich_text_content" jsonb,
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_spacer" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"space_fields_settings_bg" "enum_pages_blocks_spacer_space_fields_settings_bg",
  	"space_fields_ignore" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "pages_blocks_upload" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_cta_cta_fields_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"link_type" "enum__pages_v_blocks_cta_cta_fields_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"_uuid" varchar
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_cta" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"cta_fields_settings_bg" "enum__pages_v_blocks_cta_cta_fields_settings_bg",
  	"cta_fields_style" "enum__pages_v_blocks_cta_cta_fields_style" DEFAULT 'buttons',
  	"cta_fields_rich_text" jsonb,
  	"cta_fields_command_line" varchar,
  	"cta_fields_banner_link_type" "enum__pages_v_blocks_cta_cta_fields_banner_link_type" DEFAULT 'reference',
  	"cta_fields_banner_link_new_tab" boolean,
  	"cta_fields_banner_link_url" varchar,
  	"cta_fields_banner_link_label" varchar,
  	"cta_fields_banner_link_appearance" "enum__pages_v_blocks_cta_cta_fields_banner_link_appearance" DEFAULT 'default',
  	"cta_fields_banner_image_id" integer,
  	"cta_fields_gradient_background" boolean,
  	"_uuid" varchar,
  	"block_name" varchar
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_media_block" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"media_block_fields_settings_bg" "enum__pages_v_blocks_media_block_media_block_fields_settings_bg",
  	"media_block_fields_position" "enum__pages_v_blocks_media_block_media_block_fields_position" DEFAULT 'default',
  	"media_block_fields_media_id" integer,
  	"media_block_fields_caption" jsonb,
  	"_uuid" varchar,
  	"block_name" varchar
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_banner" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"banner_fields_settings_bg" "enum__pages_v_blocks_banner_banner_fields_settings_bg",
  	"banner_fields_banner_type" "enum__pages_v_blocks_banner_banner_fields_banner_type" DEFAULT 'default',
  	"banner_fields_add_checkmark" boolean,
  	"banner_fields_rich_text_content" jsonb,
  	"_uuid" varchar,
  	"block_name" varchar
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_spacer" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"space_fields_settings_bg" "enum__pages_v_blocks_spacer_space_fields_settings_bg",
  	"space_fields_ignore" varchar,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_upload" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_cta_cta_fields_links" ADD CONSTRAINT "pages_blocks_cta_cta_fields_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_cta"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_cta" ADD CONSTRAINT "pages_blocks_cta_cta_fields_banner_image_id_media_id_fk" FOREIGN KEY ("cta_fields_banner_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_media_block" ADD CONSTRAINT "pages_blocks_media_block_media_block_fields_media_id_media_id_fk" FOREIGN KEY ("media_block_fields_media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_upload" ADD CONSTRAINT "pages_blocks_upload_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_cta_cta_fields_links" ADD CONSTRAINT "_pages_v_blocks_cta_cta_fields_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_cta"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_cta" ADD CONSTRAINT "_pages_v_blocks_cta_cta_fields_banner_image_id_media_id_fk" FOREIGN KEY ("cta_fields_banner_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_media_block" ADD CONSTRAINT "_pages_v_blocks_media_block_media_block_fields_media_id_media_id_fk" FOREIGN KEY ("media_block_fields_media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_upload" ADD CONSTRAINT "_pages_v_blocks_upload_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_cta_cta_fields_links_order_idx" ON "pages_blocks_cta_cta_fields_links" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_cta_cta_fields_links_parent_id_idx" ON "pages_blocks_cta_cta_fields_links" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_cta_cta_fields_cta_fields_banner_image_idx" ON "pages_blocks_cta" USING btree ("cta_fields_banner_image_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_media_block_media_block_fields_media_block_fields_media_idx" ON "pages_blocks_media_block" USING btree ("media_block_fields_media_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_upload_order_idx" ON "pages_blocks_upload" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_upload_parent_id_idx" ON "pages_blocks_upload" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_upload_path_idx" ON "pages_blocks_upload" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_cta_cta_fields_links_order_idx" ON "_pages_v_blocks_cta_cta_fields_links" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_cta_cta_fields_links_parent_id_idx" ON "_pages_v_blocks_cta_cta_fields_links" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_cta_cta_fields_cta_fields_banner_image_idx" ON "_pages_v_blocks_cta" USING btree ("cta_fields_banner_image_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_media_block_media_block_fields_media_block_fields_media_idx" ON "_pages_v_blocks_media_block" USING btree ("media_block_fields_media_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_upload_order_idx" ON "_pages_v_blocks_upload" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_upload_parent_id_idx" ON "_pages_v_blocks_upload" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_upload_path_idx" ON "_pages_v_blocks_upload" USING btree ("_path");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_pages_blocks_cta_cta_fields_links_link_type";
  DROP TYPE "public"."enum_pages_blocks_cta_cta_fields_settings_bg";
  DROP TYPE "public"."enum_pages_blocks_cta_cta_fields_style";
  DROP TYPE "public"."enum_pages_blocks_cta_cta_fields_banner_link_type";
  DROP TYPE "public"."enum_pages_blocks_cta_cta_fields_banner_link_appearance";
  DROP TYPE "public"."enum_pages_blocks_media_block_media_block_fields_settings_bg";
  DROP TYPE "public"."enum_pages_blocks_media_block_media_block_fields_position";
  DROP TYPE "public"."enum_pages_blocks_banner_banner_fields_settings_bg";
  DROP TYPE "public"."enum_pages_blocks_banner_banner_fields_banner_type";
  DROP TYPE "public"."enum_pages_blocks_spacer_space_fields_settings_bg";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_cta_cta_fields_links_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_cta_cta_fields_settings_bg";
  DROP TYPE "public"."enum__pages_v_blocks_cta_cta_fields_style";
  DROP TYPE "public"."enum__pages_v_blocks_cta_cta_fields_banner_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_cta_cta_fields_banner_link_appearance";
  DROP TYPE "public"."enum__pages_v_blocks_media_block_media_block_fields_settings_bg";
  DROP TYPE "public"."enum__pages_v_blocks_media_block_media_block_fields_position";
  DROP TYPE "public"."enum__pages_v_blocks_banner_banner_fields_settings_bg";
  DROP TYPE "public"."enum__pages_v_blocks_banner_banner_fields_banner_type";
  DROP TYPE "public"."enum__pages_v_blocks_spacer_space_fields_settings_bg";
