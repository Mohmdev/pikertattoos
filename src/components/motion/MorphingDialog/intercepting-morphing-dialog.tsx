...
function MorphingDialog({ children, transition, isOpen, onOpenChange }: MorphingDialogProps) {
  return (
    <MorphingDialogProvider isOpen={isOpen} onOpenChange={onOpenChange} transition={transition}>
      {children}
