...
export type PresetType = 'blur' | 'fadeInBlur' | 'scale' | 'fade' | 'slide'

export type PerType = 'word' | 'character' | 'line'
  ...
  const content =
    per === 'line' ? (
      ...
      <motion.span className="inline-block whitespace-pre">
        {segment.split('').map((character, characterIndex) => (
          <motion.span
...
const splitText = (text: string, per: 'line' | 'word' | 'character') => {
...
const createVariantsWithTransition = (
  ...
  const { exit: _unused, ...mainTransition } = transition
